import { $n as toRefs, Dt as mergeProps, Kn as ref, Mn as effectScope, Nn as getCurrentScope, Ot as nextTick, Qn as toRef, U as computed, Ut as provide, Vn as onScopeDispose, W as createBaseVNode, Wn as reactive, Yn as shallowRef, Zn as toRaw, _n as watchEffect, ar as normalizeClass, er as toValue, et as createVNode, gn as watch, hn as warn, nt as defineComponent$1, pt as h, ut as getCurrentInstance$1, xt as inject$1 } from "./vue.runtime.esm-bundler-BKMCCr0F.js";
...
function splitKeyCombination(combination) {
	...
	if (combination.length > 1 && [
		...
		"//",
		"__"
	].some((v) => combination.startsWith(v)) || combination.includes("++") || combination.includes("//") || combination.includes("__") || combination === "+" || combination === "/" || combination === "_" || combination.length > 1 && (combination.endsWith("+") || combination.endsWith("/") || combination.endsWith("_")) && combination.at(-2) !== combination.at(-1) || combination === "++" || combination === "//" || combination === "--" || combination === "__") {
